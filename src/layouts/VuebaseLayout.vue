<template>
    <v-app>
        <v-navigation-drawer width="250" class="blue-grey darken-4" dark persistent :mini-variant="miniVariant"
            ...
            <v-list subheader :class="{'list-border-bottom' : miniVariant}">
                <v-subheader>LABORATORY</v-subheader>
        ...
        <v-toolbar app flat dense color="primary" dark>
            ...
            <div :class="{'searching--closed': !searching}" class="searching">
                <v-text-field id="search" v-model="search" append-icon="close" @click:append="searchEnd" label="Search"
                    hide-details single-line color="white" @blur="onBlur"></v-text-field>
            </div>
    ...
    data() {
        return {
            ...
            analyticsItems: [
                ...
                {
                    icon: 'laptop',
                    title: 'Midterm Laboratory 1',
                    link: '/midterm-lab-1'
                },
                {
                    icon: 'laptop',
                    title: 'Midterm Laboratory 2',
                    link: '/midterm-lab-2'
                },
                {
            ...
            developItems: [
                {
                    icon: 'star',
                    title: 'Personal Life',
                    link: '/personal-life/get-to-know-me'
                },
                {
                    icon: 'code',
                    title: 'Programming Skills',
                    link: '/personal-life/programming-skills'
                },
                {
                    icon: 'book',
                    title: 'My Program',
                    link: '/personal-life/my-program'
                },
                {
                    icon: 'school',
                    title: 'My School',
